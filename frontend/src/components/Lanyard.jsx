...
// Replace with your own imports, or place card.glb and lanyard.png in the public directory.
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-screen w-full bg-red-50 text-red-600 p-8 text-center">
          <h2 className="text-xl font-bold mb-2">3D Assets Missing!</h2>
          <p className="max-w-md">The required <b>card.glb</b> and <b>lanyard.png</b> files were not found or failed to load. Please place them in the <code>frontend/public/</code> directory and refresh the page.</p>
        </div>
      );
    }
  ...
  return (
    <ErrorBoundary>
      <div className="lanyard-wrapper">
        ...
        >
          <Suspense fallback={<Html center><div className="text-gray-500 font-medium">Loading 3D Assets...</div></Html>}>
